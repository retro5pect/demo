...
import { Tabs, TabList, TabPanels, Tab, TabPanel, Select, SimpleGrid, Tooltip } from '@chakra-ui/react'
  ...
  <AccordionItem>
    ...
    <Tooltip label="퀴즈 횟수 : 1 / 정답률 : 10%" arial-label="A tooltip" placement="top">
      <AccordionButton>
        ...
        은하계의 다양한 별자리 <Badge colorScheme='blue' mx = {1}>지구과학</Badge>
...
<StatGroup>
  ...
  <br></br>
    ...
    <p className="text-2xl">별은 뭐시기뭐시기</p>
    <br></br>
    <SimpleGrid columns={2} spacing={5}>
  <Box bg='LightPink' height='80px' className="text-center my-auto">
    <div className="my-auto mx-auto">
  <span className="text-1xl"> 1. 별1 </span>
  <Stat>
    <StatLabel></StatLabel>
  ...
  <Box bg='LightPink' height='80px' className="text-center my-auto border-solid border-2 border-black">
  <span className="text-1xl"> 2. 별2 </span>
  <Stat>
    <StatLabel></StatLabel>
  ...
  <Box bg='LightGreen' height='80px' className="text-center my-auto border-solid border-2 border-black">
  <span className="text-1xl"> 3. 별3 </span>
  <Stat>
    <StatLabel></StatLabel>
  ...
  <Box bg='LightPink' height='80px' className="text-center my-auto border-solid border-2 border-black">
  <span className="text-1xl"> 4. 별4 </span>
  <Stat>
    <StatLabel></StatLabel>
    <StatNumber>10%</StatNumber>
    <StatHelpText>
...
<Accordion allowToggle>
  <AccordionItem>
    <h2>
      <AccordionButton>
        <Box flex='1' textAlign='left'>
          우리나라의 다양한 산 <Badge colorScheme='blue' mx = {1}>지구과학</Badge>
  <Badge colorScheme='gray' mx = {1}>고등학교</Badge>
        </Box>
        <AccordionIcon />
      </AccordionButton>
...
<StatGroup>
  ...
  <Box bg='LightPink' height='80px' className="text-center my-auto border-dotted border-4 border-black">
  ...
  <Box bg='LightGreen' height='80px' className="text-center my-auto">
  ...
  <AccordionItem>
    ...
    <div className="my-30 mx-30">
  <br></br> 
  <span className="text-2xl">일반 상대성 이론 </span>
  <Badge colorScheme='blue' mx = {1}>물리학</Badge>
  <Badge colorScheme='gray' mx = {1}>고등학교</Badge>
...
<StatGroup>
  ...
  <AccordionItem>
    ...
    <AccordionPanel pb={4}>
    <div className="my-30 mx-30"> 
  <span className="text-2xl"> 시스템 아키텍처(x64) </span>
  <Badge colorScheme='blue' mx = {1}>컴퓨터공학</Badge>
  <Badge colorScheme='gray' mx = {1}>고등학교</Badge>
